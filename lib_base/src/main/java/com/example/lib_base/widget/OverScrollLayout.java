...
public class OverScrollLayout extends RelativeLayout {
    ...
    public OverScrollLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        overScrollText =  ResourceUtils.INSTANCE.getString(R.string.main_see_more);
        overScrollChangeText = ResourceUtils.INSTANCE.getString(R.string.main_release_view);
        textSize = ta.getDimensionPixelSize(R.styleable.OverScrollLayout_textSize, 32);
        textColor = ta.getColor(R.styleable.OverScrollLayout_textColor, Color.parseColor("#A1A1A1"));
